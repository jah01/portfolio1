...
//    };
    ...
    $("#proj5").click(function() {
        $("#tf").html("<div class=\"pFirst\"><img src=\"img/dewit.svg\" align=\"left\" class=\"projPic imgRounded\"></div><p class=\"pFirst\"><a href=\"https://www.github.com/jah01/Dewit\" target=\"_blank\" class=\"linkSeen\">View on Github</a><br />The final project I have showcased here is an Android app titled Dewit. A couple of my friends and I are currently creating this app to help people complete daily tasks and reach their goals. It is coded using Flutter and Dart. This was the first time any of us had really gone in depth with Android Studio and our first real expereience creating an app. The hardest part of this project is lack of experience.</p>");
        imgDiv();
